...
{
    [MUGSHOT_LORELEI] = LEHRER_PIC_ELITE_FOUR_LORELEI,
    [MUGSHOT_BRUNO]   = LEHRER_PIC_ELITE_FOUR_BRUNO,
    [MUGSHOT_AGATHA]  = LEHRER_PIC_ELITE_FOUR_AGATHA,
    [MUGSHOT_LANCE]   = LEHRER_PIC_ELITE_FOUR_LANCE,
    [MUGSHOT_BLUE]    = LEHRER_PIC_CHAMPION_RIVAL,
};
