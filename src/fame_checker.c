...
#define FC_NONLEHRER_START 0xFE00
...
#define FAME_CHECKER_PROF_OAK  (FC_NONLEHRER_START + 0)
#define FAME_CHECKER_DAISY_OAK (FC_NONLEHRER_START + 1)
#define FAME_CHECKER_BILL      (FC_NONLEHRER_START + 2)
#define FAME_CHECKER_MR_FUJI   (FC_NONLEHRER_START + 3)

static const u16 sTrainerIdxs[] = {
    [FAMECHECKER_OAK]      = FAME_CHECKER_PROF_OAK,
    [FAMECHECKER_DAISY]    = FAME_CHECKER_DAISY_OAK,
    [FAMECHECKER_BROCK]    = LEHRER_CHEF_BROCK,
    [FAMECHECKER_MISTY]    = LEHRER_CHEF_MISTY,
    [FAMECHECKER_LTSURGE]  = LEHRER_CHEF_LT_SURGE,
    [FAMECHECKER_ERIKA]    = LEHRER_CHEF_ERIKA,
    [FAMECHECKER_KOGA]     = LEHRER_CHEF_KOGA,
    [FAMECHECKER_SABRINA]  = LEHRER_CHEF_SABRINA,
    [FAMECHECKER_BLAINE]   = LEHRER_CHEF_BLAINE,
    [FAMECHECKER_LORELEI]  = LEHRER_ELITE_FOUR_LORELEI,
    [FAMECHECKER_BRUNO]    = LEHRER_ELITE_FOUR_BRUNO,
    [FAMECHECKER_AGATHA]   = LEHRER_ELITE_FOUR_AGATHA,
    [FAMECHECKER_LANCE]    = LEHRER_ELITE_FOUR_LANCE,
    [FAMECHECKER_BILL]     = FAME_CHECKER_BILL,
    [FAMECHECKER_MRFUJI]   = FAME_CHECKER_MR_FUJI,
    [FAMECHECKER_GIOVANNI] = LEHRER_BOSS_GIOVANNI
};
...
static const u8 sFameCheckerTrainerPicIdxs[] = {
    [FAMECHECKER_OAK]      = LEHRER_PIC_CAMPER,
    [FAMECHECKER_DAISY]    = LEHRER_PIC_LASS,
    [FAMECHECKER_BROCK]    = LEHRER_PIC_CHEF_BROCK,
    [FAMECHECKER_MISTY]    = LEHRER_PIC_CHEF_MISTY,
    [FAMECHECKER_LTSURGE]  = LEHRER_PIC_CHEF_LT_SURGE,
    [FAMECHECKER_ERIKA]    = LEHRER_PIC_CHEF_ERIKA,
    [FAMECHECKER_KOGA]     = LEHRER_PIC_CHEF_KOGA,
    [FAMECHECKER_SABRINA]  = LEHRER_PIC_CHEF_SABRINA,
    [FAMECHECKER_BLAINE]   = LEHRER_PIC_CHEF_BLAINE,
    [FAMECHECKER_LORELEI]  = LEHRER_PIC_ELITE_FOUR_LORELEI,
    [FAMECHECKER_BRUNO]    = LEHRER_PIC_ELITE_FOUR_BRUNO,
    [FAMECHECKER_AGATHA]   = LEHRER_PIC_ELITE_FOUR_AGATHA,
    [FAMECHECKER_LANCE]    = LEHRER_PIC_ELITE_FOUR_LANCE,
    [FAMECHECKER_BILL]     = LEHRER_PIC_PSYCHIC_M,
    [FAMECHECKER_MRFUJI]   = LEHRER_PIC_GENTLEMAN,
    [FAMECHECKER_GIOVANNI] = LEHRER_PIC_CHEF_GIOVANNI,
};
...
{
    if (HasTrainerBeenFought(LEHRER_CHEF_GIOVANNI) == TRUE)
    {
        if (a0 == 9)
...
static u8 FC_PopulateListMenu(void)
{
    ...
    for (i = 0; i < NUM_FAMECHECKER_PERSONS; i++)
    {
        ...
        {
            if (sTrainerIdxs[fameCheckerIdx] < FC_NONLEHRER_START)
            {
            ...
            {
                sListMenuItems[nitems].label = sNonTrainerNamePointers[sTrainerIdxs[fameCheckerIdx] - FC_NONLEHRER_START];
                sListMenuItems[nitems].index = nitems;
            }
