...
static const u8 sText_Trainer1LoseText[] = _("{B_LEHRER1_LOSE_TEXT}");
static const u8 sText_Trainer2LoseText[] = _("{B_LEHRER2_LOSE_TEXT}");
static const u8 sText_Trainer1RecallPkmn1[] = _("{B_LEHRER1_NAME}: {B_OPPONENT_MON1_NAME}, come back!");
static const u8 sText_Trainer1WinText[] = _("{B_LEHRER1_WIN_TEXT}");
static const u8 sText_Trainer1RecallPkmn2[] = _("{B_LEHRER1_NAME}: {B_OPPONENT_MON2_NAME}, come back!");
static const u8 sText_Trainer1RecallBoth[] = _("{B_LEHRER1_NAME}: {B_OPPONENT_MON1_NAME} and\n{B_OPPONENT_MON2_NAME}, come back!");
static const u8 sText_Trainer2WinText[] = _("{B_LEHRER2_WIN_TEXT}");
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} gained{B_BUFF2}\n{B_BUFF3} EXP. Points!{PAUSE 32}"); // \p"); //was here
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" a boosted");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} grew to\nLV. {B_BUFF2}!"); // {WAIT_SE}{PAUSE 32}"); // \p"); //was here
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} learned\n{B_BUFF2}!"); // {WAIT_SE}{PAUSE 32}"); // \p"); //was here
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} is trying to\nlearn {B_BUFF2}.{PAUSE 32}"); // \p"); //was here
static const u8 sText_TryToLearnMove2[] = _("But, {B_BUFF1} can't learn\nmore than four moves.{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_UseNextPkmn[] = _("Use next Pimmel?");
...
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} is out of\nusable Pimmel!{PAUSE 32}"); // \p"); //was here
static const u8 sText_PlayerPanicked[] = _("{B_PLAYER_NAME} panicked and lost ¥{B_BUFF1}…\p… … … …\p{B_PLAYER_NAME} whited out!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("{B_PLAYER_NAME} is out of\nusable Pimmel!\pPlayer lost against\n{B_LEHRER1_CLASS} {B_LEHRER1_NAME}!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("{B_PLAYER_NAME} paid ¥{B_BUFF1} as the prize\nmoney…\p… … … …\p{B_PLAYER_NAME} whited out!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} whited out!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
static const u8 sText_PreventsEscape[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} prevents\nescape with {B_SCR_ACTIVE_ABILITY}!{PAUSE 32}"); // \p"); //was here
static const u8 sText_CantEscape2[] = _("Can't escape!{PAUSE 32}"); // \p"); //was here
...
const u8 gText_PkmnsXPreventsSwitching[] = _("{B_BUFF1}'s {B_LAST_ABILITY}\nprevents switching!{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2, and{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}Poof!{PAUSE 32}"); // \p"); //was here
static const u8 sText_AndEllipsis[] = _("And…{PAUSE 32}"); // \p"); //was here
static const u8 sText_HMMovesCantBeForgotten[] = _("HM moves can't be\nforgotten now.{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE SE_FLEE}Got away safely!{PAUSE 32}"); // \p"); //was here
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fled\nusing its {B_LAST_ITEM}!{PAUSE 32}"); // \p"); //was here
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX} fled\nusing {B_ATK_ABILITY}!{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_NoRunningFromTrainers[] = _("No! There's no running\nfrom a LEHRER battle!{PAUSE 32}"); // \p"); //was here
static const u8 sText_CantEscape[] = _("Can't escape!{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_FaintInThree[] = _("All affected Pimmel will\nfaint in three turns!");
static const u8 sText_NoPPLeft[] = _("There's no PP left for\nthis move!{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}ANNOUNCER: You're out of\nSAFARI-Eier! Game over!{PAUSE 32}"); // \p"); //was here
static const u8 sText_WildPkmnAppeared[] = _("Wild {B_OPPONENT_MON1_NAME} appeared!{PAUSE 32}"); // \p"); //was here
static const u8 sText_WildPkmnAppeared2[] = _("Wild {B_OPPONENT_MON1_NAME} appeared!{PAUSE 32}"); // \p"); //was here
static const u8 sText_WildPkmnAppearedPause[] = _("Wild {B_OPPONENT_MON1_NAME} appeared!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("Wild {B_OPPONENT_MON1_NAME} and\n{B_OPPONENT_MON2_NAME} appeared!{PAUSE 32}"); // \p"); //was here
static const u8 sText_GhostAppearedCantId[] = _("The GHOST appeared!\pDarn!\nThe GHOST can't be ID'd!{PAUSE 32}"); // \p"); //was here
static const u8 sText_TheGhostAppeared[] = _("The GHOST appeared!{PAUSE 32}"); // \p"); //was here
...
static const u8 sText_Trainer1WantsToBattle[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME}\nwould like to battle!{PAUSE 32}"); // \p"); //was here
static const u8 sText_LinkTrainerWantsToBattle[] = _("{B_LINK_OPPONENT1_NAME}\nwants to battle!");
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME} and {B_LINK_OPPONENT2_NAME}\nwant to battle!");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME} sent\nout {B_OPPONENT_MON1_NAME}!{PAUSE 60}");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME} sent\nout {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME}!{PAUSE 60}");
static const u8 sText_Trainer1SentOutPkmn2[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME} sent\nout {B_BUFF1}!");
...
static const u8 sText_LinkTrainerMultiSentOutPkmn[] = _("{B_LINK_SCR_LEHRER_NAME} sent out\n{B_BUFF1}!");
...
static const u8 sText_Trainer1WithdrewPkmn[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME}\nwithdrew {B_BUFF1}!");
static const u8 sText_LinkTrainer1WithdrewPkmn[] = _("{B_LINK_OPPONENT1_NAME} withdrew\n{B_BUFF1}!");
static const u8 sText_LinkTrainer2WithdrewPkmn[] = _("{B_LINK_SCR_LEHRER_NAME} withdrew\n{B_BUFF1}!");
...
static const u8 sText_PokedudeUsedItem[] = _("The PimmelDUDE used\n{B_LAST_ITEM}!");
static const u8 sText_Trainer1UsedItem[] = _("{B_LEHRER1_CLASS} {B_LEHRER1_NAME}\nused {B_LAST_ITEM}!");
static const u8 sText_TrainerBlockedBall[] = _("The LEHRER blocked the BALL!");
...
static const u8 sText_PkmnHearingFluteAwoke[] = _("The Pimmel hearing the FLUTE\nawoke!");
static const u8 sText_YouThrowABallNowRight[] = _("You throw a BALL now, right?\nI… I'll do my best!");
const u8 gText_ForPetesSake[] = _("EICH: Oh, for Fuck's sake…\nSo pushy, as always.\p{B_PLAYER_NAME}.\pYou've never had a Pimmel battle\nbefore, have you?\pA Pimmel battle is when LEHRERS\npit their Pimmel against each\lother.{PAUSE 32}"); // \p"); //was here
const u8 gText_TheTrainerThat[] = _("The LEHRER that makes the other\nLEHRER's Pimmel faint by lowering\ltheir HP to “0,” wins.{PAUSE 32}"); // \p"); //was here
const u8 gText_TryBattling[] = _("But rather than talking about it,\nyou'll learn more from experience.\pTry battling and see for yourself.{PAUSE 32}"); // \p"); //was here
const u8 gText_InflictingDamageIsKey[] = _("EICH: Inflicting damage on the foe\nis the key to any battle.{PAUSE 32}"); // \p"); //was here
const u8 gText_LoweringStats[] = _("EICH: Lowering the foe's stats\nwill put you at an advantage.{PAUSE 32}"); // \p"); //was here
const u8 gText_KeepAnEyeOnHP[] = _("EICH: Keep your eyes on your\nPimmel's HP.\pIt will faint if the HP drops to\n“0.”{PAUSE 32}"); // \p"); //was here
const u8 gText_OakNoRunningFromATrainer[] = _("EICH: No! There's no running away\nfrom a LEHRER Pimmel battle!{PAUSE 32}"); // \p"); //was here
const u8 gText_WinEarnsPrizeMoney[] = _("EICH: Hm! Excellent!\pIf you win, you earn prize money,\nand your Pimmel will grow!\pBattle other LEHRERS and make\nyour Pimmel strong!{PAUSE 32}"); // \p"); //was here
const u8 gText_HowDissapointing[] = _("EICH: Hm…\nHow disappointing…\pIf you win, you earn prize money,\nand your Pimmel grow.\pBut if you lose, {B_PLAYER_NAME}, you end\nup paying prize money…\pHowever, since you had no warning\nthis time, I'll pay for you.\pBut things won't be this way once\nyou step outside these doors.\pThat's why you must strengthen your\nPimmel by battling wild Pimmel.{PAUSE 32}"); // \p"); //was here

const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    [STRINGID_LEHRER1LOSETEXT - BATTLESTRINGS_TABLE_START]              = sText_Trainer1LoseText,
    ...
    [STRINGID_NORUNNINGFROMLEHRERS - BATTLESTRINGS_TABLE_START]         = sText_NoRunningFromTrainers,
    ...
    [STRINGID_LEHRERBLOCKEDBALL - BATTLESTRINGS_TABLE_START]            = sText_TrainerBlockedBall,
    ...
    [STRINGID_PLAYERDEFEATEDLEHRER1 - BATTLESTRINGS_TABLE_START]        = sText_PlayerDefeatedLinkTrainerTrainer1,
    ...
    [STRINGID_LEHRER1USEDITEM - BATTLESTRINGS_TABLE_START]              = sText_Trainer1UsedItem,
    ...
    [STRINGID_PLAYERLOSTAGAINSTENEMYLEHRER - BATTLESTRINGS_TABLE_START] = sText_PlayerWhiteoutAgainstTrainer,
    ...
    [STRINGID_LEHRER2LOSETEXT - BATTLESTRINGS_TABLE_START]              = sText_Trainer2LoseText,
    [STRINGID_LEHRER2WINTEXT - BATTLESTRINGS_TABLE_START]               = sText_Trainer2WinText,
    ...
    [STRINGID_LEHRER1MON1COMEBACK - BATTLESTRINGS_TABLE_START]          = sText_Trainer1RecallPkmn1,
    [STRINGID_LEHRER1WINTEXT - BATTLESTRINGS_TABLE_START]               = sText_Trainer1WinText,
    [STRINGID_LEHRER1MON2COMEBACK - BATTLESTRINGS_TABLE_START]          = sText_Trainer1RecallPkmn2,
    [STRINGID_LEHRER1MON1AND2COMEBACK - BATTLESTRINGS_TABLE_START]      = sText_Trainer1RecallBoth
};
...
{
    STRINGID_LEHRER1MON1COMEBACK,
    STRINGID_LEHRER1MON1COMEBACK,
    STRINGID_LEHRER1MON2COMEBACK,
    STRINGID_LEHRER1MON1AND2COMEBACK
};
...
const u8 gText_SafariZoneMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Ei{CLEAR_TO 56}Bait\nRock{CLEAR_TO 56}-");
...
static const u8 sText_Defense[] = _("Defende");
...
const u8 gText_SafariBalls[] = _("{HIGHLIGHT 2}SAFARI-Eier"); //
...
static const u8 sText_Trainer1Fled[] = _("{PLAY_SE SE_FLEE}{B_LEHRER1_CLASS} {B_LEHRER1_NAME} fled!");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("Player lost against\n{B_LEHRER1_CLASS} {B_LEHRER1_NAME}!");
...
void BufferStringBattle(u16 stringId)
{
    ...
    *(&gBattleStruct->stringMoveType) = sBattleMsgDataPtr->moveType;
    ...
    case STRINGID_INTROSENDOUT: // poke first send-out
        ...
        else
        {
            ...
            else
            {
                ...
                else if (gTrainerBattleOpponent_A == LEHRER_UNION_ROOM)
                    stringPtr = sText_Trainer1SentOutPkmn;
                else
    ...
    case STRINGID_RETURNMON: // sending poke to ball msg
        ...
        {
            if (gTrainerBattleOpponent_A == LEHRER_LINK_OPPONENT)
            {
                if (gBattleTypeFlags & BATTLE_TYPE_MULTI)
    ...
    while (*src != EOS)
    {
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_EFF_ABILITY: // effect battlerId ability
                ...
                break;
            case B_TXT_LEHRER1_CLASS: // trainer class name
                ...
                break;
            case B_TXT_LEHRER1_NAME: // trainer1 name
                if (gTrainerBattleOpponent_A == LEHRER_SECRET_BASE)
                {
                ...
                {
                    if (gTrainers[gTrainerBattleOpponent_A].trainerClass == LEHRER_CLASS_RIVAL_EARLY
                     || gTrainers[gTrainerBattleOpponent_A].trainerClass == LEHRER_CLASS_RIVAL_LATE
            ...
            case B_TXT_LINK_OPPONENT2_NAME: // link opponent 2 name
                ...
                break;
            case B_TXT_LINK_SCR_LEHRER_NAME: // link scripting active name
                toCpy = gLinkPlayers[GetBattlerMultiplayerId(gBattleScripting.battler)].name;
                break;
            case B_TXT_PLAYER_NAME: // player name
                toCpy = gSaveBlock2Ptr->playerName;
                break;
            case B_TXT_LEHRER1_LOSE_TEXT: // trainerA lose text
                ...
                break;
            case B_TXT_LEHRER1_WIN_TEXT: // trainerA win text
                if (gBattleTypeFlags & BATTLE_TYPE_LEHRER_TOWER)
                {
                ...
                break;
            case B_TXT_LEHRER2_LOSE_TEXT:
                GetTrainerTowerOpponentLoseText(gStringVar4, 1);
                toCpy = gStringVar4;
                break;
            case B_TXT_LEHRER2_WIN_TEXT:
            ...
            if (*src == B_TXT_LEHRER1_LOSE_TEXT || *src == B_TXT_LEHRER1_WIN_TEXT
             || *src == B_TXT_LEHRER2_LOSE_TEXT || *src == B_TXT_LEHRER2_WIN_TEXT)
            {
...
{
    if (stringId == STRINGID_LEHRER1LOSETEXT
     || stringId == STRINGID_LEHRER2LOSETEXT
     || stringId == STRINGID_LEHRER1WINTEXT
     || stringId == STRINGID_LEHRER2WINTEXT)
        return TRUE;
    return FALSE;
}
