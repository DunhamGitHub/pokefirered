...
typedef enum
{
    ...
    VSSEEKER_RESPONSE_UNFOUGHT_LEHRERS,
...
static const VsSeekerData sVsSeekerData[] = {
   { {LEHRER_YOUNGSTER_BEN, LEHRER_YOUNGSTER_BEN_2, 0xFFFF, LEHRER_YOUNGSTER_BEN_3, LEHRER_YOUNGSTER_BEN_4},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_YOUNGSTER_CALVIN, LEHRER_YOUNGSTER_CALVIN},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_BUG_CATCHER_COLTON, LEHRER_BUG_CATCHER_COLTON_2, 0xFFFF, LEHRER_BUG_CATCHER_COLTON_3, 0xFFFF, LEHRER_BUG_CATCHER_COLTON_4},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_BUG_CATCHER_GREG, LEHRER_BUG_CATCHER_GREG},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_BUG_CATCHER_JAMES, LEHRER_BUG_CATCHER_JAMES},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_LASS_JANICE, LEHRER_LASS_JANICE_2, 0xFFFF, LEHRER_LASS_JANICE_3},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_LASS_SALLY, LEHRER_LASS_SALLY},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_LASS_ROBIN, LEHRER_LASS_ROBIN},
      MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3) },
   { {LEHRER_LASS_CRISSY, LEHRER_LASS_CRISSY},
      MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4) },
   { {LEHRER_YOUNGSTER_TIMMY, LEHRER_YOUNGSTER_TIMMY_2, 0xFFFF, LEHRER_YOUNGSTER_TIMMY_3, 0xFFFF, LEHRER_YOUNGSTER_TIMMY_4},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_BUG_CATCHER_CALE, LEHRER_BUG_CATCHER_CALE},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_LASS_RELI, LEHRER_LASS_RELI_2, 0xFFFF, LEHRER_LASS_RELI_3},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_LASS_ALI, LEHRER_LASS_ALI},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_CAMPER_SHANE, LEHRER_CAMPER_SHANE},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_CAMPER_ETHAN, LEHRER_CAMPER_ETHAN},
      MAP_GROUP(ROUTE24), MAP_NUM(ROUTE24) },
   { {LEHRER_YOUNGSTER_JOEY, LEHRER_YOUNGSTER_JOEY},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_YOUNGSTER_DAN, LEHRER_YOUNGSTER_DAN},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_YOUNGSTER_CHAD, LEHRER_YOUNGSTER_CHAD_2, 0xFFFF, LEHRER_YOUNGSTER_CHAD_3, LEHRER_YOUNGSTER_CHAD_4},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_PICNICKER_KELSEY, LEHRER_PICNICKER_KELSEY_2, 0xFFFF, LEHRER_PICNICKER_KELSEY_3, LEHRER_PICNICKER_KELSEY_4},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_LASS_HALEY, LEHRER_LASS_HALEY},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_HIKER_FRANKLIN, 0xFFFF, LEHRER_HIKER_FRANKLIN_2},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_HIKER_NOB, LEHRER_HIKER_NOB},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_HIKER_WAYNE, LEHRER_HIKER_WAYNE},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_CAMPER_FLINT, LEHRER_CAMPER_FLINT},
      MAP_GROUP(ROUTE25), MAP_NUM(ROUTE25) },
   { {LEHRER_BUG_CATCHER_KEIGO, LEHRER_BUG_CATCHER_KEIGO},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_BUG_CATCHER_ELIJAH, LEHRER_BUG_CATCHER_ELIJAH},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_CAMPER_RICKY, LEHRER_CAMPER_RICKY_2, 0xFFFF, LEHRER_CAMPER_RICKY_3, 0xFFFF, LEHRER_CAMPER_RICKY_4},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_CAMPER_JEFF, LEHRER_CAMPER_JEFF_2, 0xFFFF, LEHRER_CAMPER_JEFF_3, 0xFFFF, LEHRER_CAMPER_JEFF_4},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_PICNICKER_NANCY, LEHRER_PICNICKER_NANCY},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_PICNICKER_ISABELLE, LEHRER_PICNICKER_ISABELLE_2, 0xFFFF, LEHRER_PICNICKER_ISABELLE_3, LEHRER_PICNICKER_ISABELLE_4},
      MAP_GROUP(ROUTE6), MAP_NUM(ROUTE6) },
   { {LEHRER_YOUNGSTER_EDDIE, LEHRER_YOUNGSTER_EDDIE},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_YOUNGSTER_DILLON, LEHRER_YOUNGSTER_DILLON},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_YOUNGSTER_YASU, 0xFFFF, LEHRER_YOUNGSTER_YASU_2, 0xFFFF, LEHRER_YOUNGSTER_YASU_3},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_YOUNGSTER_DAVE, LEHRER_YOUNGSTER_DAVE},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_ENGINEER_BRAXTON, LEHRER_ENGINEER_BRAXTON},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_ENGINEER_BERNIE, 0xFFFF, 0xFFFF, LEHRER_ENGINEER_BERNIE_2},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_GAMER_HUGO, LEHRER_GAMER_HUGO},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_GAMER_JASPER, LEHRER_GAMER_JASPER},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_GAMER_DIRK, LEHRER_GAMER_DIRK},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_GAMER_DARIAN, 0xFFFF, 0xFFFF, LEHRER_GAMER_DARIAN_2},
      MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11) },
   { {LEHRER_BUG_CATCHER_BRENT, LEHRER_BUG_CATCHER_BRENT},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_BUG_CATCHER_CONNER, LEHRER_BUG_CATCHER_CONNER},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_CAMPER_CHRIS, 0xFFFF, LEHRER_CAMPER_CHRIS_2, LEHRER_CAMPER_CHRIS_3, 0xFFFF, LEHRER_CAMPER_CHRIS_4},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_CAMPER_DREW, LEHRER_CAMPER_DREW},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_PICNICKER_ALICIA, 0xFFFF, LEHRER_PICNICKER_ALICIA_2, LEHRER_PICNICKER_ALICIA_3, 0xFFFF, LEHRER_PICNICKER_ALICIA_4},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_PICNICKER_CAITLIN, LEHRER_PICNICKER_CAITLIN},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_HIKER_ALAN, LEHRER_HIKER_ALAN},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_HIKER_BRICE, LEHRER_HIKER_BRICE},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_HIKER_JEREMY, 0xFFFF, 0xFFFF, LEHRER_HIKER_JEREMY_2},
      MAP_GROUP(ROUTE9), MAP_NUM(ROUTE9) },
   { {LEHRER_PICNICKER_HEIDI, LEHRER_PICNICKER_HEIDI},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_PICNICKER_CAROL, LEHRER_PICNICKER_CAROL},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_POKEMANIAC_MARK, 0xFFFF, 0xFFFF, LEHRER_POKEMANIAC_MARK_2, 0xFFFF, LEHRER_POKEMANIAC_MARK_3},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_POKEMANIAC_HERMAN, 0xFFFF, 0xFFFF, LEHRER_POKEMANIAC_HERMAN_2, 0xFFFF, LEHRER_POKEMANIAC_HERMAN_3},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_HIKER_CLARK, LEHRER_HIKER_CLARK},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_HIKER_TRENT, 0xFFFF, 0xFFFF, LEHRER_HIKER_TRENT_2},
      MAP_GROUP(ROUTE10), MAP_NUM(ROUTE10) },
   { {LEHRER_LASS_PAIGE, LEHRER_LASS_PAIGE},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_LASS_ANDREA, LEHRER_LASS_ANDREA},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_LASS_MEGAN, 0xFFFF, LEHRER_LASS_MEGAN_2, 0xFFFF, LEHRER_LASS_MEGAN_3},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_LASS_JULIA, LEHRER_LASS_JULIA},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_SUPER_NERD_AIDAN, LEHRER_SUPER_NERD_AIDAN},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_SUPER_NERD_GLENN, 0xFFFF, 0xFFFF, LEHRER_SUPER_NERD_GLENN_2},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_SUPER_NERD_LESLIE, LEHRER_SUPER_NERD_LESLIE},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_GAMER_STAN, LEHRER_GAMER_STAN},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_GAMER_RICH, 0xFFFF, 0xFFFF, LEHRER_GAMER_RICH_2},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_TWINS_ELI_ANNE, 0xFFFF, 0xFFFF, LEHRER_TWINS_ELI_ANNE_2},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_BIKER_RICARDO, LEHRER_BIKER_RICARDO},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_BIKER_JAREN, 0xFFFF, 0xFFFF, LEHRER_BIKER_JAREN_2},
      MAP_GROUP(ROUTE8), MAP_NUM(ROUTE8) },
   { {LEHRER_FISHERMAN_NED, LEHRER_FISHERMAN_NED},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_FISHERMAN_CHIP, LEHRER_FISHERMAN_CHIP},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_FISHERMAN_HANK, LEHRER_FISHERMAN_HANK},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_FISHERMAN_ELLIOT, 0xFFFF, 0xFFFF, LEHRER_FISHERMAN_ELLIOT_2},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_FISHERMAN_ANDREW, LEHRER_FISHERMAN_ANDREW},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_ROCKER_LUCA, 0xFFFF, 0xFFFF, LEHRER_ROCKER_LUCA_2},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_CAMPER_JUSTIN, LEHRER_CAMPER_JUSTIN},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_YOUNG_COUPLE_GIA_JES, 0xFFFF, 0xFFFF, LEHRER_YOUNG_COUPLE_GIA_JES_2, 0xFFFF, LEHRER_YOUNG_COUPLE_GIA_JES_3},
      MAP_GROUP(ROUTE12), MAP_NUM(ROUTE12) },
   { {LEHRER_BIKER_JARED, LEHRER_BIKER_JARED},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BEAUTY_LOLA, LEHRER_BEAUTY_LOLA},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BEAUTY_SHEILA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BEAUTY_SHEILA_2},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BIRD_KEEPER_SEBASTIAN, LEHRER_BIRD_KEEPER_SEBASTIAN},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BIRD_KEEPER_PERRY, LEHRER_BIRD_KEEPER_PERRY},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BIRD_KEEPER_ROBERT, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_ROBERT_2, LEHRER_BIRD_KEEPER_ROBERT_3},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_PICNICKER_ALMA, LEHRER_PICNICKER_ALMA},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_PICNICKER_SUSIE, 0xFFFF, 0xFFFF, LEHRER_PICNICKER_SUSIE_2, LEHRER_PICNICKER_SUSIE_3, LEHRER_PICNICKER_SUSIE_4},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_PICNICKER_VALERIE, LEHRER_PICNICKER_VALERIE},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_PICNICKER_GWEN, LEHRER_PICNICKER_GWEN},
      MAP_GROUP(ROUTE13), MAP_NUM(ROUTE13) },
   { {LEHRER_BIKER_MALIK, LEHRER_BIKER_MALIK},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIKER_LUKAS, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIKER_LUKAS_2},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIKER_ISAAC, LEHRER_BIKER_ISAAC},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIKER_GERALD, LEHRER_BIKER_GERALD},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_DONALD, LEHRER_BIRD_KEEPER_DONALD},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_BENNY, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_BENNY_2, LEHRER_BIRD_KEEPER_BENNY_3},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_CARTER, LEHRER_BIRD_KEEPER_CARTER},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_MITCH, LEHRER_BIRD_KEEPER_MITCH},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_BECK, LEHRER_BIRD_KEEPER_BECK},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIRD_KEEPER_MARLON, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_MARLON_2, LEHRER_BIRD_KEEPER_MARLON_3},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_TWINS_KIRI_JAN, LEHRER_TWINS_KIRI_JAN},
      MAP_GROUP(ROUTE14), MAP_NUM(ROUTE14) },
   { {LEHRER_BIKER_ERNEST, LEHRER_BIKER_ERNEST},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BIKER_ALEX, LEHRER_BIKER_ALEX},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BEAUTY_GRACE, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BEAUTY_GRACE_2},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BEAUTY_OLIVIA, LEHRER_BEAUTY_OLIVIA},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BIRD_KEEPER_EDWIN, LEHRER_BIRD_KEEPER_EDWIN},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BIRD_KEEPER_CHESTER, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_CHESTER_2, LEHRER_BIRD_KEEPER_CHESTER_3},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_PICNICKER_YAZMIN, LEHRER_PICNICKER_YAZMIN},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_PICNICKER_KINDRA, LEHRER_PICNICKER_KINDRA},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_PICNICKER_BECKY, 0xFFFF, 0xFFFF, LEHRER_PICNICKER_BECKY_2, LEHRER_PICNICKER_BECKY_3, LEHRER_PICNICKER_BECKY_4},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_PICNICKER_CELIA, LEHRER_PICNICKER_CELIA},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_CRUSH_KIN_RON_MYA, 0xFFFF, 0xFFFF, LEHRER_CRUSH_KIN_RON_MYA_2, LEHRER_CRUSH_KIN_RON_MYA_3, LEHRER_CRUSH_KIN_RON_MYA_4},
      MAP_GROUP(ROUTE15), MAP_NUM(ROUTE15) },
   { {LEHRER_BIKER_LAO, LEHRER_BIKER_LAO},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_BIKER_HIDEO, LEHRER_BIKER_HIDEO},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_BIKER_RUBEN, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIKER_RUBEN_2},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_CUE_BALL_KOJI, LEHRER_CUE_BALL_KOJI},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_CUE_BALL_LUKE, LEHRER_CUE_BALL_LUKE},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_CUE_BALL_CAMRON, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CUE_BALL_CAMRON_2},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_YOUNG_COUPLE_LEA_JED, LEHRER_YOUNG_COUPLE_LEA_JED},
      MAP_GROUP(ROUTE16), MAP_NUM(ROUTE16) },
   { {LEHRER_BIKER_BILLY, LEHRER_BIKER_BILLY},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_BIKER_NIKOLAS, LEHRER_BIKER_NIKOLAS},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_BIKER_JAXON, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIKER_JAXON_2},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_BIKER_WILLIAM, LEHRER_BIKER_WILLIAM},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_CUE_BALL_RAUL, LEHRER_CUE_BALL_RAUL},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_CUE_BALL_ISAIAH, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CUE_BALL_ISAIAH_2},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_CUE_BALL_ZEEK, LEHRER_CUE_BALL_ZEEK},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_CUE_BALL_JAMAL, LEHRER_CUE_BALL_JAMAL},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_CUE_BALL_COREY, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CUE_BALL_COREY_2},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_BIKER_VIRGIL, LEHRER_BIKER_VIRGIL},
      MAP_GROUP(ROUTE17), MAP_NUM(ROUTE17) },
   { {LEHRER_BIRD_KEEPER_WILTON, LEHRER_BIRD_KEEPER_WILTON},
      MAP_GROUP(ROUTE18), MAP_NUM(ROUTE18) },
   { {LEHRER_BIRD_KEEPER_RAMIRO, LEHRER_BIRD_KEEPER_RAMIRO},
      MAP_GROUP(ROUTE18), MAP_NUM(ROUTE18) },
   { {LEHRER_BIRD_KEEPER_JACOB, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_JACOB_2, LEHRER_BIRD_KEEPER_JACOB_3},
      MAP_GROUP(ROUTE18), MAP_NUM(ROUTE18) },
   { {LEHRER_SWIMMER_MALE_RICHARD, LEHRER_SWIMMER_MALE_RICHARD},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_REECE, LEHRER_SWIMMER_MALE_REECE},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_MATTHEW, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_MATTHEW_2},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_DOUGLAS, LEHRER_SWIMMER_MALE_DOUGLAS},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_DAVID, LEHRER_SWIMMER_MALE_DAVID},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_TONY, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_TONY_2},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_AXLE, LEHRER_SWIMMER_MALE_AXLE},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_FEMALE_ANYA, LEHRER_SWIMMER_FEMALE_ANYA},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_FEMALE_ALICE, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_FEMALE_ALICE_2},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_FEMALE_CONNIE, LEHRER_SWIMMER_FEMALE_CONNIE},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SIS_AND_BRO_LIA_LUC, LEHRER_SIS_AND_BRO_LIA_LUC},
      MAP_GROUP(ROUTE19), MAP_NUM(ROUTE19) },
   { {LEHRER_SWIMMER_MALE_BARRY, LEHRER_SWIMMER_MALE_BARRY},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_MALE_DEAN, LEHRER_SWIMMER_MALE_DEAN},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_MALE_DARRIN, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_DARRIN_2},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_FEMALE_TIFFANY, LEHRER_SWIMMER_FEMALE_TIFFANY},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_FEMALE_NORA, LEHRER_SWIMMER_FEMALE_NORA},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_FEMALE_MELISSA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_FEMALE_MELISSA_2},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_SWIMMER_FEMALE_SHIRLEY, LEHRER_SWIMMER_FEMALE_SHIRLEY},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_BIRD_KEEPER_ROGER, LEHRER_BIRD_KEEPER_ROGER},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_PICNICKER_MISSY, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PICNICKER_MISSY_2, LEHRER_PICNICKER_MISSY_3},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_PICNICKER_IRENE, LEHRER_PICNICKER_IRENE},
      MAP_GROUP(ROUTE20), MAP_NUM(ROUTE20) },
   { {LEHRER_FISHERMAN_RONALD, LEHRER_FISHERMAN_RONALD},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_FISHERMAN_CLAUDE, LEHRER_FISHERMAN_CLAUDE},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_FISHERMAN_WADE, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_FISHERMAN_WADE_2},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_FISHERMAN_NOLAN, LEHRER_FISHERMAN_NOLAN},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SWIMMER_MALE_SPENCER, LEHRER_SWIMMER_MALE_SPENCER},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SWIMMER_MALE_JACK, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_JACK_2},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SWIMMER_MALE_JEROME, LEHRER_SWIMMER_MALE_JEROME},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SWIMMER_MALE_ROLAND, LEHRER_SWIMMER_MALE_ROLAND},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SIS_AND_BRO_LIL_IAN, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SIS_AND_BRO_LIL_IAN_2, LEHRER_SIS_AND_BRO_LIL_IAN_3},
      MAP_GROUP(ROUTE21_NORTH), MAP_NUM(ROUTE21_NORTH) },
   { {LEHRER_SWIMMER_FEMALE_MARIA, LEHRER_SWIMMER_FEMALE_MARIA},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_SWIMMER_FEMALE_ABIGAIL, LEHRER_SWIMMER_FEMALE_ABIGAIL},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_SWIMMER_MALE_FINN, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_FINN_2},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_SWIMMER_MALE_GARRETT, LEHRER_SWIMMER_MALE_GARRETT},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_FISHERMAN_TOMMY, LEHRER_FISHERMAN_TOMMY},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_CRUSH_GIRL_SHARON, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CRUSH_GIRL_SHARON_2, LEHRER_CRUSH_GIRL_SHARON_3},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_CRUSH_GIRL_TANYA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CRUSH_GIRL_TANYA_2, LEHRER_CRUSH_GIRL_TANYA_3},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_BLACK_BELT_SHEA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BLACK_BELT_SHEA_2, LEHRER_BLACK_BELT_SHEA_3},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_BLACK_BELT_HUGH, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BLACK_BELT_HUGH_2, LEHRER_BLACK_BELT_HUGH_3},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_CAMPER_BRYCE, LEHRER_CAMPER_BRYCE},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_PICNICKER_CLAIRE, LEHRER_PICNICKER_CLAIRE},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_CRUSH_KIN_MIK_KIA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CRUSH_KIN_MIK_KIA_2, LEHRER_CRUSH_KIN_MIK_KIA_3},
      MAP_GROUP(ONE_ISLAND_KINDLE_ROAD), MAP_NUM(ONE_ISLAND_KINDLE_ROAD) },
   { {LEHRER_SWIMMER_FEMALE_AMARA, LEHRER_SWIMMER_FEMALE_AMARA},
      MAP_GROUP(ONE_ISLAND_TREASURE_BEACH), MAP_NUM(ONE_ISLAND_TREASURE_BEACH) },
   { {LEHRER_AROMA_LADY_NIKKI, LEHRER_AROMA_LADY_NIKKI},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_AROMA_LADY_VIOLET, LEHRER_AROMA_LADY_VIOLET},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_TUBER_AMIRA, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_TUBER_AMIRA_2},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_TUBER_ALEXIS, LEHRER_TUBER_ALEXIS},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_SWIMMER_FEMALE_TISHA, LEHRER_SWIMMER_FEMALE_TISHA},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_TWINS_JOY_MEG, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_TWINS_JOY_MEG_2},
      MAP_GROUP(THREE_ISLAND_BOND_BRIDGE), MAP_NUM(THREE_ISLAND_BOND_BRIDGE) },
   { {LEHRER_PAINTER_DAISY, LEHRER_PAINTER_DAISY},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_PAINTER_CELINA, LEHRER_PAINTER_CELINA},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_PAINTER_RAYNA, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PAINTER_RAYNA_2},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_LADY_JACKI, LEHRER_LADY_JACKI},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_LADY_GILLIAN, LEHRER_LADY_GILLIAN},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_YOUNGSTER_DESTIN, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_YOUNGSTER_DESTIN_2},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_SWIMMER_MALE_TOBY, LEHRER_SWIMMER_MALE_TOBY},
      MAP_GROUP(FIVE_ISLAND_RESORT_GORGEOUS), MAP_NUM(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {LEHRER_PKMN_BREEDER_ALIZE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PKMN_BREEDER_ALIZE_2},
      MAP_GROUP(FIVE_ISLAND_WATER_LABYRINTH), MAP_NUM(FIVE_ISLAND_WATER_LABYRINTH) },
   { {LEHRER_BIRD_KEEPER_MILO, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_MILO_2},
      MAP_GROUP(FIVE_ISLAND_MEMORIAL_PILLAR), MAP_NUM(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {LEHRER_BIRD_KEEPER_CHAZ, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_CHAZ_2},
      MAP_GROUP(FIVE_ISLAND_MEMORIAL_PILLAR), MAP_NUM(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {LEHRER_BIRD_KEEPER_HAROLD, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_BIRD_KEEPER_HAROLD_2},
      MAP_GROUP(FIVE_ISLAND_MEMORIAL_PILLAR), MAP_NUM(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {LEHRER_FISHERMAN_TYLOR, LEHRER_FISHERMAN_TYLOR},
      MAP_GROUP(SIX_ISLAND_OUTCAST_ISLAND), MAP_NUM(SIX_ISLAND_OUTCAST_ISLAND) },
   { {LEHRER_SWIMMER_MALE_MYMO, LEHRER_SWIMMER_MALE_MYMO},
      MAP_GROUP(SIX_ISLAND_OUTCAST_ISLAND), MAP_NUM(SIX_ISLAND_OUTCAST_ISLAND) },
   { {LEHRER_SWIMMER_FEMALE_NICOLE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_FEMALE_NICOLE_2},
      MAP_GROUP(SIX_ISLAND_OUTCAST_ISLAND), MAP_NUM(SIX_ISLAND_OUTCAST_ISLAND) },
   { {LEHRER_SIS_AND_BRO_AVA_GEB, LEHRER_SIS_AND_BRO_AVA_GEB},
      MAP_GROUP(SIX_ISLAND_OUTCAST_ISLAND), MAP_NUM(SIX_ISLAND_OUTCAST_ISLAND) },
   { {LEHRER_PSYCHIC_JACLYN, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PSYCHIC_JACLYN_2},
      MAP_GROUP(SIX_ISLAND_GREEN_PATH), MAP_NUM(SIX_ISLAND_GREEN_PATH) },
   { {LEHRER_AROMA_LADY_ROSE, LEHRER_AROMA_LADY_ROSE},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_JUGGLER_EDWARD, LEHRER_JUGGLER_EDWARD},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_SWIMMER_MALE_SAMIR, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_SWIMMER_MALE_SAMIR_2},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_SWIMMER_FEMALE_DENISE, LEHRER_SWIMMER_FEMALE_DENISE},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_TWINS_MIU_MIA, LEHRER_TWINS_MIU_MIA},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_HIKER_EARL, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_HIKER_EARL_2},
      MAP_GROUP(SIX_ISLAND_WATER_PATH), MAP_NUM(SIX_ISLAND_WATER_PATH) },
   { {LEHRER_RUIN_MANIAC_STANLY, LEHRER_RUIN_MANIAC_STANLY},
      MAP_GROUP(SIX_ISLAND_RUIN_VALLEY), MAP_NUM(SIX_ISLAND_RUIN_VALLEY) },
   { {LEHRER_RUIN_MANIAC_FOSTER, LEHRER_RUIN_MANIAC_FOSTER},
      MAP_GROUP(SIX_ISLAND_RUIN_VALLEY), MAP_NUM(SIX_ISLAND_RUIN_VALLEY) },
   { {LEHRER_RUIN_MANIAC_LARRY, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_RUIN_MANIAC_LARRY_2},
      MAP_GROUP(SIX_ISLAND_RUIN_VALLEY), MAP_NUM(SIX_ISLAND_RUIN_VALLEY) },
   { {LEHRER_HIKER_DARYL, LEHRER_HIKER_DARYL},
      MAP_GROUP(SIX_ISLAND_RUIN_VALLEY), MAP_NUM(SIX_ISLAND_RUIN_VALLEY) },
   { {LEHRER_POKEMANIAC_HECTOR, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_POKEMANIAC_HECTOR_2},
      MAP_GROUP(SIX_ISLAND_RUIN_VALLEY), MAP_NUM(SIX_ISLAND_RUIN_VALLEY) },
   { {LEHRER_PSYCHIC_DARIO, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PSYCHIC_DARIO_2},
      MAP_GROUP(SEVEN_ISLAND_LEHRER_TOWER), MAP_NUM(SEVEN_ISLAND_LEHRER_TOWER) },
   { {LEHRER_PSYCHIC_RODETTE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PSYCHIC_RODETTE_2},
      MAP_GROUP(SEVEN_ISLAND_LEHRER_TOWER), MAP_NUM(SEVEN_ISLAND_LEHRER_TOWER) },
   { {LEHRER_AROMA_LADY_MIAH, LEHRER_AROMA_LADY_MIAH},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {LEHRER_YOUNG_COUPLE_EVE_JON, LEHRER_YOUNG_COUPLE_EVE_JON},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {LEHRER_JUGGLER_MASON, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_JUGGLER_MASON_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {LEHRER_PKMN_RANGER_NICOLAS, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PKMN_RANGER_NICOLAS_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {LEHRER_PKMN_RANGER_MADELINE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PKMN_RANGER_MADELINE_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {LEHRER_CRUSH_GIRL_CYNDY, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_CRUSH_GIRL_CYNDY_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_TAMER_EVAN, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_TAMER_EVAN_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_PKMN_RANGER_JACKSON, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PKMN_RANGER_JACKSON_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_PKMN_RANGER_KATELYN, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_PKMN_RANGER_KATELYN_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_COOLLEHRER_LEROY, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_COOLLEHRER_LEROY_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_COOLLEHRER_MICHELLE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_COOLLEHRER_MICHELLE_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_COOL_COUPLE_LEX_NYA, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, LEHRER_COOL_COUPLE_LEX_NYA_2},
      MAP_GROUP(SEVEN_ISLAND_SEVAULT_CANYON), MAP_NUM(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {LEHRER_RUIN_MANIAC_BRANDON, LEHRER_RUIN_MANIAC_BRANDON},
      MAP_GROUP(SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(SEVEN_ISLAND_TANOBY_RUINS) },
   { {LEHRER_RUIN_MANIAC_BENJAMIN, LEHRER_RUIN_MANIAC_BENJAMIN},
      MAP_GROUP(SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(SEVEN_ISLAND_TANOBY_RUINS) },
   { {LEHRER_PAINTER_EDNA, LEHRER_PAINTER_EDNA},
      MAP_GROUP(SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(SEVEN_ISLAND_TANOBY_RUINS) },
   { {LEHRER_GENTLEMAN_CLIFFORD, LEHRER_GENTLEMAN_CLIFFORD},
      MAP_GROUP(SEVEN_ISLAND_TANOBY_RUINS), MAP_NUM(SEVEN_ISLAND_TANOBY_RUINS) },
};
...
void VsSeekerResetObjectMovementAfterChargeComplete(void)
{
    ...
    {
        if ((templates[i].objUnion.normal.trainerType == LEHRER_TYPE_NORMAL
          || templates[i].objUnion.normal.trainerType == LEHRER_TYPE_BURIED) 
...
static void GatherNearbyTrainerInfo(void)
{
    ...
    {
        if (templates[objectEventIdx].objUnion.normal.trainerType == LEHRER_TYPE_NORMAL || templates[objectEventIdx].objUnion.normal.trainerType == LEHRER_TYPE_BURIED)
        {
...
static u8 GetVsSeekerResponseInArea(const VsSeekerData * vsSeekerData)
{
    ...
    if (sVsSeeker->trainerHasNotYetBeenFought)
        return VSSEEKER_RESPONSE_UNFOUGHT_LEHRERS;
...
void ClearRematchStateByTrainerId(void)
{
    ...
    if (vsSeekerDataIdx != -1)
    {
        ...
        for (i = 0; i < gMapHeader.events->objectEventCount; i++)
        {
            if ((objectEventTemplates[i].objUnion.normal.trainerType == LEHRER_TYPE_NORMAL 
              || objectEventTemplates[i].objUnion.normal.trainerType == LEHRER_TYPE_BURIED)
...
static u8 GetRunningBehaviorFromGraphicsId(u8 graphicsId)
{
    switch (graphicsId)
    {
        ...
        case OBJ_EVENT_GFX_COOLLEHRER_M:
        case OBJ_EVENT_GFX_COOLLEHRER_F:
