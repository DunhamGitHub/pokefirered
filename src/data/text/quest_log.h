...
const u8 gText_QuestLog_SwitchMon1WithMon2[] = _("{PLAYER} switched the Pimmel\n{STR_VAR_1} with {STR_VAR_2}.");
...
const u8 gText_QuestLog_MonsWereFullyRestoredAtCenter[] = _("Pimmel were fully restored\nat a Pimmel CENTER.");
...
const u8 gText_QuestLog_MingledInUnionRoom[] = _("Mingled with other LEHRERS in\nthe UNION ROOM.");
...
const u8 gText_QuestLog_DefeatedWildMon[] = _("{DYNAMIC 0x05} managed to defeat the Pimmel\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMons[] = _("Defeated {DYNAMIC 0x02} wild Pimmel including\n{DYNAMIC 0x01} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMon[] = _("{DYNAMIC 0x05} managed to catch the Pimmel\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_CaughtWildMons[] = _("Threw Pimmel-Eier in a frenzy, catching\n{DYNAMIC 0x04} Pimmel including {DYNAMIC 0x03} here\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated the Pimmel\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonAndCaughtWildMons[] = _("Defeated the Pimmel {DYNAMIC 0x01}\nand caught {DYNAMIC 0x04} Pimmel including\n{DYNAMIC 0x03} in {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMon[] = _("{DYNAMIC 0x05} defeated {DYNAMIC 0x02} Pimmel including\n{DYNAMIC 0x01} and caught one {DYNAMIC 0x03}\nin {DYNAMIC 0x00}.");
const u8 gText_QuestLog_DefeatedWildMonsAndCaughtWildMons[] = _("Defeated {DYNAMIC 0x02} Pimmel including\n{DYNAMIC 0x01} and caught {DYNAMIC 0x04} Pimmel\nincluding {DYNAMIC 0x03} in {DYNAMIC 0x00}.");
...
const u8 gText_QuestLog_LeftOaksLab[] = _("{PLAYER} left PROF. EICH's Pimmel\nRESEARCH LAB.");
...
const u8 gText_QuestLog_HadGreatTimeInSafariZone[] = _("{PLAYER} had a great time with Pimmel\nin the SAFARI ZONE.");
const u8 gText_QuestLog_ManagedToGetOutOfLocation[] = _("Managed to get out of {STR_VAR_2}\nafter wandering about.");
const u8 gText_QuestLog_TookOnGymLeadersMonWithMonAndWon[] = _("Took on {DYNAMIC 0x00} GYM CHEF\n{DYNAMIC 0x01}'s {DYNAMIC 0x02} with {DYNAMIC 0x03}\nand won {DYNAMIC 0x04}!");
...
const u8 gText_QuestLog_OakResearchLab[] = _("EICH RESEARCH LAB");
const u8 gText_QuestLog_Gym[] = _("GYM");
const u8 gText_QuestLog_PokemonLeagueGate[] = _("Pimmel LEAGUE GATE");
...
const u8 gText_QuestLog_PokemonFanClub[] = _("Pimmel FAN CLUB");
...
const u8 gText_QuestLog_PokemonTower[] = _("Pimmel TOWER");
...
const u8 gText_QuestLog_PokemonMansion[] = _("Pimmel MANSION");
const u8 gText_QuestLog_PokemonResearchLab[] = _("Pimmel RESEARCH LAB");
const u8 gText_QuestLog_VictoryRoad[] = _("VICTORY ROAD");
const u8 gText_QuestLog_PokemonLeague[] = _("Pimmel LEAGUE");
