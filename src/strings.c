...
const u8 gText_PokedexTableOfContents[] = _("Lexikon   Table Of Contents");
...
const u8 gText_PokemonHabitats[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Pimmel HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("Grassland Pimmel");
const u8 gText_DexCategory_ForestPkmn[] = _("Forest Pimmel");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("Water's-Edge Pimmel");
const u8 gText_DexCategory_SeaPkmn[] = _("Sea Pimmel");
const u8 gText_DexCategory_CavePkmn[] = _("Cave Pimmel");
const u8 gText_DexCategory_MountainPkmn[] = _("Mountain Pimmel");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("Rough-Terrain Pimmel");
const u8 gText_DexCategory_UrbanPkmn[] = _("Urban Pimmel");
const u8 gText_DexCategory_RarePkmn[] = _("Rare Pimmel");
...
const u8 gText_ClosePokedex[] = _("Close Lexikon");
...
const u8 gText_PokemonList[] = _("{COLOR DYNAMIC_COLOR6}{SHADOW DYNAMIC_COLOR5}Pimmel LIST");
const u8 gText_NumericalModeKanto[] = _("NUMERICAL MODE: KANTO");
const u8 gText_NumericalModeNational[] = _("NUMERICAL MODE: NATIONAL");
const u8 gText_PokemonListNoColor[] = _("Pimmel List");
...
const u8 gText_PokedexPokemon[] = _(" Pimmel");
...
const u8 gSaveStatName_Pokedex[] = _("Lexikon");
...
const u8 gText_PokeBalls2[] = _("Pimmel-Eier");
...
const u8 gText_OakForbidsUseOfItemHere[] = _("EICH: {PLAYER}!\nThis isn't the time to use that!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantDismountBike[] = _("You can't dismount your BIKE here.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_ItemfinderShakingWildly[] = _("Oh!\nThe ITEMFINDER's shaking wildly!\pThere's an item buried underfoot!\p‥ ‥ ‥ ‥ ‥ ‥{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the Pimmel-Flööte.\pNow, that's a catchy tune!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the Pimmel-Flööte.");
const u8 gText_PokeFluteAwakenedMon[] = _("The Pimmel-Flööte awakened sleeping\nPimmel.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggCantBattle[] = _("An EGG can't battle!{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_CantUseUntilNewBadge[] = _("This can't be used until a new\nBADGE is obtained.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanThreeMayEnter[] = _("No more than three Pimmel\nmay enter.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreThanTwoMayEnter[] = _("No more than two Pimmel\nmay enter.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_SendMailToPC[] = _("Send the removed MAIL to\nyour PC?");
const u8 gText_MailSentToPC[] = _("The MAIL was sent to your PC.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
const u8 gText_PCMailboxFull[] = _("Your PC's MAILBOX is full.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagFullCouldNotRemoveItem[] = _("The {STR_VAR_1} is full. The Pimmel's\nitem could not be removed.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_TwoPokemonAreNeeded[] = _("Two Pimmel Are Needed.");
...
const u8 gText_OakImportantToGetToKnowPokemonThroughly[] = _("EICH: It's important to get to know\nyour Pimmel thoroughly.\p");
const u8 gText_OakThisIsListOfPokemon[] = _("This is a list of your Pimmel,\n{PLAYER}.\pOpen this to check the skills\nand moves of your Pimmel.\pYou also choose Pimmel here if\nyou want to use an item on one.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_LureWildPokemon[] = _("Lure Wild Pimmel.");
...
const u8 gText_StoreItemsInThePC[] = _("Store Items in the MAC");
const u8 gText_TakeOutItemsFromThePC[] = _("Take out Items from the MAC");
const u8 gText_ThrowAwayItemsInPC[] = _("パソコンに あずけている\nどうぐを すてます");
const u8 gText_ThereAreNoItems[] = _("There are no items.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_TheresNoMailHere[] = _("There's no MAIL here.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_BagIsFull[] = _("The BAG is full.{PAUSE 32}"); // {PAUSE_UNTIL_PRESS}");
...
const u8 gText_ReturnToPC[] = _("Return to the Mac");
...
const u8 gText_PokeBalls[] = _("Pimmel-Eier");
...
const u8 gText_SomeoneSPc[] = _("Someone's MAC");
const u8 gText_BillSPc[] = _("Bill's MAC");
const u8 gText_SPc[] = _("{PLAYER}'s MAC");
const u8 gText_HallOfFame_2[] = _("Hall Of Fame");
const u8 gText_LogOff[] = _("Log Off");
const u8 gText_ProfOakSPc[] = _("Prof. Eich's MAC");
...
const u8 gText_PokeBallsPocket[] = _("Pimmel-Eier Pocket");
const u8 gText_TmCase[] = _("Tm Case");
...
const u8 gPCText_Pokecenter[] = _("Pimmel-Klub");
...
const u8 gText_WithdrawMonDescription[] = _("You can withdraw a Pimmel if you\nhave any in a BOX.");
const u8 gText_DepositMonDescription[] = _("You can deposit your party\nPimmel in any BOX.");
const u8 gText_MoveMonDescription[] = _("You can move Pimmel that are\nstored in any BOX.");
const u8 gText_MoveItemsDescription[] = _("You can move items held by any\nPimmel in a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("See You Later!");
const u8 gText_JustOnePkmn[] = _("Can't Deposit The Last Pimmel!");
const u8 gText_PartyFull[] = _("Can't Take Any More Pimmel.");
...
const u8 gText_PokeSum_EggOrigin_DayCare[] = _("An odd Pimmel EGG found by the\nDAY-CARE couple.");
const u8 gText_PokeSum_EggOrigin_TravelingMan[] = _("An odd Pimmel EGG obtained from\nthe traveling man.");
const u8 gText_PokeSum_EggOrigin_NicePlace[] = _("A wondrously peculiar Pimmel EGG\nobtained at a nice place.");
const u8 gText_PokeSum_EggOrigin_Spa[] = _("An odd Pimmel EGG obtained from\nan old woman at the SPA.");
const u8 gText_PokeSum_EggOrigin_Trade[] = _("A peculiar Pimmel EGG obtained\nin a trade.");
...
const u8 gText_PokeSum_PageName_PokemonInfo[] = _("Pimmel Info");
const u8 gText_PokeSum_PageName_PokemonSkills[] = _("Pimmel Skills");
...
const u8 gText_TrainerCardPokedex[] = _("Lexikon");
...
const u8 gText_WaitingTrainerFinishReading[] = _("Waiting for the other LEHRER to\nfinish reading your LEHRER CARD.");
...
const u8 gStartMenuDesc_Pokedex[] = _("A device that records Pimmel secrets\nupon meeting or catching them.");
const u8 gStartMenuDesc_Pokemon[] = _("Check and organize Pimmel that are\ntraveling with you in your party.");
...
const u8 gText_LeaderHasLeftEndingChat[] = _("The CHEF, {DYNAMIC 0x00}, has\nleft, ending the chat.");
...
const u8 gText_IfLeaderLeavesChatWillEnd[] = _("If the CHEF leaves, the chat\nwill end. Is that okay?");
...
const u8 gText_Pokedex[] = _("Lexikon");
...
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers[] = _("Pimmel Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Ken_Sugimori_Motofumi_Fujiwara_Shigeki_Morimoto_Hironobu_Yoshida[] = _("\nKen Sugimori\nMotofumi Fujiwara\nShigeki Morimoto\nHironobu Yoshida\n\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_2[] = _("Pimmel Designers\n\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Satoshi_Ohta_Asuka_Iwashita_Takao_Unno_Kanako_Eo_Aimi_Tomita[] = _("\nSatoshi Ohta\nAsuka Iwashita\nTakao Unno\nKanako Eo\nAimi Tomita\n");
ALIGNED(4) const u8 gCreditsString_POKeMON_Designers_3[] = _("Pimmel Designers\n\n\n\n\n\n");
...
const u8 gTradeText_ChooseAPokemon[] = _("Choose A Pimmel.");
...
const u8 gText_Trade_OnlyPkmnForBattle[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}That's your only Pimmel\nfor battle.");
...
const u8 gText_OtherTrainerHasCard[] = _("The other LEHRER has the same\nWONDER CARD already.");
const u8 gText_OtherTrainerHasNews[] = _("The other LEHRER has the same\nWONDER NEWS already.");
const u8 gText_OtherTrainerHasStamp[] = _("The other LEHRER has the same\nSTAMP already.");
const u8 gText_OtherTrainerCanceled[] = _("The other LEHRER canceled\ncommunication.");
