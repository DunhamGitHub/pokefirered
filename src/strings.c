...
const u8 gText_PlayedPokeFluteCatchy[] = _("Played the PimmelFLUTE.\pNow, that's a catchy tune!{PAUSE_UNTIL_PRESS}");
const u8 gText_PlayedPokeFlute[] = _("Played the PimmelFLUTE.");
const u8 gText_PokeFluteAwakenedMon[] = _("The PimmelFLUTE awakened sleeping\nPimmel.{PAUSE_UNTIL_PRESS}");
