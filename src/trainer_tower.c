...
#define LEHRER_TOWER gSaveBlock1Ptr->trainerTower[gSaveBlock1Ptr->towerChallengeId]
...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_COOLLEHRER_M,  FACILITY_CLASS_RS_COOLLEHRER_M,    MALE},
    {OBJ_EVENT_GFX_COOLLEHRER_F,  FACILITY_CLASS_RS_COOLLEHRER_F,  FEMALE},
    ...
    {OBJ_EVENT_GFX_COOLLEHRER_M,  FACILITY_CLASS_DRAGON_TAMER,        MALE},
    ...
    {OBJ_EVENT_GFX_COOLLEHRER_M,  FACILITY_CLASS_COOLLEHRER_M,       MALE},
    {OBJ_EVENT_GFX_COOLLEHRER_F,  FACILITY_CLASS_COOLLEHRER_F,     FEMALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_COOLLEHRER_M,  OBJ_EVENT_GFX_COOLLEHRER_F,  FACILITY_CLASS_COOL_COUPLE,       MALE, FEMALE},
...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[105] = {
    {FACILITY_CLASS_RS_AROMA_LADY,          LEHRER_ENCOUNTER_MUSIC_AQUA},
    {FACILITY_CLASS_BOARDER_F,              LEHRER_ENCOUNTER_MUSIC_AQUA},
    {FACILITY_CLASS_AQUA_GRUNT_F,           LEHRER_ENCOUNTER_MUSIC_AQUA},
    {FACILITY_CLASS_GAMER,                  LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_RUIN_MANIAC,         LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_YOUNGSTER,           LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_RS_YOUNG_COUPLE,        LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_FISHERMAN,           LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RUNNING_TRIATHLETE_F,   LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RS_PKMN_RANGER_M,       LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_CHEF_BRAWLY,          LEHRER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_RS_SIS_AND_BRO,         LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_MAGMA_CHEF_MAXIE,     LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_POKEFAN_F,              LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_RS_PKMN_RANGER_F,       LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PSYCHIC_M,              LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_PICNICKER,              LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_ELITE_FOUR_GLACIA,      LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_RS_COOLLEHRER_F,       LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_GUITARIST,              LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_RS_BUG_CATCHER,         LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PKMN_LEHRER_BRENDAN_3, LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RUNNING_TRIATHLETE_M,   LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_CAMPER,                 LEHRER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_CYCLING_TRIATHLETE_F,   LEHRER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_RS_TUBER_F,             LEHRER_ENCOUNTER_MUSIC_INTERVIEWER},
    {FACILITY_CLASS_BEAUTY,                 LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_INTERVIEWER,            LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_YOUNGSTER,              LEHRER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_RS_PSYCHIC_F,           LEHRER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_MAGMA_GRUNT_F,          LEHRER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_RS_SWIMMER_M,           LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_PKMN_LEHRER_MAY_3,     LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_RS_POKEMANIAC,          LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_SUPER_NERD,             LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_ENGINEER,               LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_MAGMA_ADMIN_F,          LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_RS_BLACK_BELT,          LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_CHEF_FLANNERY,        LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_RS_SAILOR,              LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_SAILOR,                 LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_BUG_MANIAC,             LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_PKMN_LEHRER_MAY,       LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RS_CAMPER,              LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_KINDLER,                LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_BATTLE_GIRL,            LEHRER_ENCOUNTER_MUSIC_MAGMA},
    {FACILITY_CLASS_COLLECTOR,              LEHRER_ENCOUNTER_MUSIC_MAGMA},
    {FACILITY_CLASS_NINJA_BOY,              LEHRER_ENCOUNTER_MUSIC_MAGMA},
    {FACILITY_CLASS_PKMN_LEHRER_BRENDAN_2, LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_PARASOL_LADY,           LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_AQUA_ADMIN_F,           LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_PKMN_LEHRER_BRENDAN,   LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RS_SWIMMER_F,           LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_EXPERT_F,               LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_RICH_BOY,               LEHRER_ENCOUNTER_MUSIC_RICH},
    {FACILITY_CLASS_HEX_MANIAC,             LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_RS_HIKER,               LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_BEAUTY,              LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_SWIMMER_F,              LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_LADY,                LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_CHAMPION_STEVEN,        LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_PKMN_LEHRER_MAY_2,     LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_CYCLING_TRIATHLETE_M,   LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_SWIMMER_M,              LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_DRAGON_TAMER,           LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_BIKER,                  LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_SWIMMING_TRIATHLETE_M,  LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_CUE_BALL,               LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_RS_BIRD_KEEPER,         LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_SWIMMING_TRIATHLETE_F,  LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_POKEMANIAC,             LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_RS_TWINS,               LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_CHEF_WATTSON,         LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_BUG_CATCHER,            LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RS_PKMN_BREEDER_M,      LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_CHEF_WALLACE,         LEHRER_ENCOUNTER_MUSIC_AQUA},
    {FACILITY_CLASS_CHEF_NORMAN,          LEHRER_ENCOUNTER_MUSIC_AQUA},
    {FACILITY_CLASS_OLD_COUPLE,             LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_RS_PSYCHIC_M,           LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_CHEF_ROXANNE,         LEHRER_ENCOUNTER_MUSIC_TWINS},
    {FACILITY_CLASS_ELITE_FOUR_DRAKE,       LEHRER_ENCOUNTER_MUSIC_ELITE_FOUR},
    {FACILITY_CLASS_RS_GENTLEMAN,           LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_RS_LASS,                LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS},
    {FACILITY_CLASS_BURGLAR,                LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_PKMN_LEHRER_WALLY,     LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_SCHOOL_KID_M,           LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_CHEF_TATE_AND_LIZA,   LEHRER_ENCOUNTER_MUSIC_INTENSE},
    {FACILITY_CLASS_POKEFAN_M,              LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_MAGMA_ADMIN_M,          LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_EXPERT_M,               LEHRER_ENCOUNTER_MUSIC_COOL},
    {FACILITY_CLASS_MAGMA_GRUNT_M,          LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_SR_AND_JR,              LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_LASS,                   LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_SCHOOL_KID_F,           LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_RS_COOLLEHRER_M,       LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_FISHERMAN,              LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_RS_TUBER_M,             LEHRER_ENCOUNTER_MUSIC_GIRL},
    {FACILITY_CLASS_HIKER,                  LEHRER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_BOARDER_M,              LEHRER_ENCOUNTER_MUSIC_SWIMMER},
    {FACILITY_CLASS_RS_PKMN_BREEDER_F,      LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_RS_PICNICKER,           LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_CHEF_WINONA,          LEHRER_ENCOUNTER_MUSIC_MALE},
    {FACILITY_CLASS_ELITE_FOUR_SIDNEY,      LEHRER_ENCOUNTER_MUSIC_FEMALE},
    {FACILITY_CLASS_AQUA_ADMIN_M,           LEHRER_ENCOUNTER_MUSIC_HIKER},
    {FACILITY_CLASS_ELITE_FOUR_PHOEBE,      LEHRER_ENCOUNTER_MUSIC_MALE}
};
...
static void (*const sTrainerTowerFunctions[])(void) = {
    [LEHRER_TOWER_FUNC_INIT_FLOOR]             = InitTrainerTowerFloor,
    [LEHRER_TOWER_FUNC_GET_SPEECH]             = BufferTowerOpponentSpeech,
    [LEHRER_TOWER_FUNC_DO_BATTLE]              = DoTrainerTowerBattle,
    [LEHRER_TOWER_FUNC_GET_CHALLENGE_TYPE]     = TrainerTowerGetChallengeType,
    [LEHRER_TOWER_FUNC_CLEARED_FLOOR]          = TrainerTowerAddFloorCleared,
    [LEHRER_TOWER_FUNC_GET_FLOOR_CLEARED]      = GetFloorAlreadyCleared,
    [LEHRER_TOWER_FUNC_START_CHALLENGE]        = StartTrainerTowerChallenge,
    [LEHRER_TOWER_FUNC_GET_OWNER_STATE]        = GetOwnerState,
    [LEHRER_TOWER_FUNC_GIVE_PRIZE]             = GiveChallengePrize,
    [LEHRER_TOWER_FUNC_CHECK_FINAL_TIME]       = CheckFinalTime,
    [LEHRER_TOWER_FUNC_RESUME_TIMER]           = TrainerTowerResumeTimer,
    [LEHRER_TOWER_FUNC_SET_LOST]               = TrainerTowerSetPlayerLost,
    [LEHRER_TOWER_FUNC_GET_CHALLENGE_STATUS]   = GetTrainerTowerChallengeStatus,
    [LEHRER_TOWER_FUNC_GET_TIME]               = GetCurrentTime,
    [LEHRER_TOWER_FUNC_SHOW_RESULTS]           = ShowResultsBoard,
    [LEHRER_TOWER_FUNC_CLOSE_RESULTS]          = CloseResultsBoard,
    [LEHRER_TOWER_FUNC_CHECK_DOUBLES]          = TrainerTowerGetDoublesEligiblity,
    [LEHRER_TOWER_FUNC_GET_NUM_FLOORS]         = TrainerTowerGetNumFloors,
    [LEHRER_TOWER_FUNC_SHOULD_WARP_TO_COUNTER] = ShouldWarpToCounter,
    [LEHRER_TOWER_FUNC_ENCOUNTER_MUSIC]        = PlayTrainerTowerEncounterMusic,
    [LEHRER_TOWER_FUNC_GET_BEAT_CHALLENGE]     = HasSpokenToOwner
};

// - 1 excludes Mixed challenge, which just uses one of the 3 other types
static const u16 sFloorLayouts[MAX_LEHRER_TOWER_FLOORS][NUM_TOWER_CHALLENGE_TYPES - 1] = {
    {LAYOUT_LEHRER_TOWER_1F, LAYOUT_LEHRER_TOWER_1F_DOUBLES, LAYOUT_LEHRER_TOWER_1F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_2F, LAYOUT_LEHRER_TOWER_2F_DOUBLES, LAYOUT_LEHRER_TOWER_2F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_3F, LAYOUT_LEHRER_TOWER_3F_DOUBLES, LAYOUT_LEHRER_TOWER_3F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_4F, LAYOUT_LEHRER_TOWER_4F_DOUBLES, LAYOUT_LEHRER_TOWER_4F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_5F, LAYOUT_LEHRER_TOWER_5F_DOUBLES, LAYOUT_LEHRER_TOWER_5F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_6F, LAYOUT_LEHRER_TOWER_6F_DOUBLES, LAYOUT_LEHRER_TOWER_6F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_7F, LAYOUT_LEHRER_TOWER_7F_DOUBLES, LAYOUT_LEHRER_TOWER_7F_KNOCKOUT},
    {LAYOUT_LEHRER_TOWER_8F, LAYOUT_LEHRER_TOWER_8F_DOUBLES, LAYOUT_LEHRER_TOWER_8F_KNOCKOUT}
};
...
static const u16 sTrainerTowerEncounterMusic[] = {
    [LEHRER_ENCOUNTER_MUSIC_MALE]        = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_FEMALE]      = MUS_ENCOUNTER_GIRL,
    [LEHRER_ENCOUNTER_MUSIC_GIRL]        = MUS_ENCOUNTER_GIRL,
    [LEHRER_ENCOUNTER_MUSIC_SUSPICIOUS]  = MUS_ENCOUNTER_ROCKET,
    [LEHRER_ENCOUNTER_MUSIC_INTENSE]     = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_COOL]        = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_AQUA]        = MUS_ENCOUNTER_ROCKET,
    [LEHRER_ENCOUNTER_MUSIC_MAGMA]       = MUS_ENCOUNTER_ROCKET,
    [LEHRER_ENCOUNTER_MUSIC_SWIMMER]     = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_TWINS]       = MUS_ENCOUNTER_GIRL,
    [LEHRER_ENCOUNTER_MUSIC_ELITE_FOUR]  = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_HIKER]       = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_INTERVIEWER] = MUS_ENCOUNTER_BOY,
    [LEHRER_ENCOUNTER_MUSIC_RICH]        = MUS_ENCOUNTER_BOY
};

// The trainer only uses two Pokemon from the encoded pool, based on the current floor
static const u8 sSingleBattleChallengeMonIdxs[MAX_LEHRER_TOWER_FLOORS][2] = {
    {0, 2},
    {1, 3},
    {2, 4},
    {3, 5},
...
static const u8 sDoubleBattleChallengeMonIdxs[MAX_LEHRER_TOWER_FLOORS][2] = {
    {0, 1},
    {1, 3},
    {2, 0},
    {3, 4},
...
// Each trainer only uses one Pokemon from the encoded pool, based on the current floor
static const u8 sKnockoutChallengeMonIdxs[MAX_LEHRER_TOWER_FLOORS][3] = {
    {0, 2, 4},
    {1, 3, 5},
    {2, 3, 1},
    {3, 4, 0},
...
extern const struct TrainerTowerFloor *const gTrainerTowerFloors[][MAX_LEHRER_TOWER_FLOORS];
...
void InitTrainerTowerBattleStruct(void)
{
    ...
    SetVBlankCounter1Ptr(&LEHRER_TOWER.timer);
    FreeTrainerTowerDataStruct();
}
...
static void SetUpTrainerTowerDataStruct(void)
{
    ...
    sTrainerTowerState->floorIdx = gMapHeader.mapLayoutId - LAYOUT_LEHRER_TOWER_1F;
    ...
    else
    {
        ...
        for (i = 0; i < MAX_LEHRER_TOWER_FLOORS; i++)
        {
...
static void InitTrainerTowerFloor(void)
{
    if (gMapHeader.mapLayoutId - LAYOUT_LEHRER_TOWER_LOBBY > sTrainerTowerState->data.numFloors)
    {
        gSpecialVar_Result = 3; // Skip past usable challenge types
        SetCurrentMapLayout(LAYOUT_LEHRER_TOWER_ROOF);
    }
    else
    {
...
static void SetTrainerTowerNPCGraphics(void)
{
    ...
    case CHALLENGE_TYPE_KNOCKOUT:
        for (j = 0; j < MAX_LEHRERS_PER_FLOOR; j++)
        {
...
static void DoTrainerTowerBattle(void)
{
    gBattleTypeFlags = BATTLE_TYPE_LEHRER | BATTLE_TYPE_LEHRER_TOWER;
...
static void GetFloorAlreadyCleared(void)
{
    ...
    if (mapLayoutId - LAYOUT_LEHRER_TOWER_1F == LEHRER_TOWER.floorsCleared 
     && mapLayoutId - LAYOUT_LEHRER_TOWER_LOBBY <= CURR_FLOOR.floorIdx)
...
static void StartTrainerTowerChallenge(void)
{
    ...
    if (!ReadTrainerTowerAndValidate())
        LEHRER_TOWER.validated = TRUE;
    else
        LEHRER_TOWER.validated = FALSE;
    LEHRER_TOWER.floorsCleared = 0;
    SetVBlankCounter1Ptr(&LEHRER_TOWER.timer);
    LEHRER_TOWER.timer = 0;
    LEHRER_TOWER.spokeToOwner = FALSE;
    LEHRER_TOWER.checkedFinalTime = FALSE;
}
...
static void GetOwnerState(void)
{
    ...
    if (LEHRER_TOWER.spokeToOwner)
        gSpecialVar_Result++;
    if (LEHRER_TOWER.receivedPrize && LEHRER_TOWER.checkedFinalTime)
        gSpecialVar_Result++;

    LEHRER_TOWER.spokeToOwner = TRUE;
}
...
static void GiveChallengePrize(void)
{
    ...
    else if (AddBagItem(itemId, 1) == TRUE)
    {
        ...
        LEHRER_TOWER.receivedPrize = TRUE;
        gSpecialVar_Result = 0;
    }
    else
    {
...
static void CheckFinalTime(void)
{
    if (LEHRER_TOWER.checkedFinalTime)
    {
        gSpecialVar_Result = 2;
    }
    else if (GetTrainerTowerRecordTime(&LEHRER_TOWER.bestTime) > LEHRER_TOWER.timer)
    {
        SetTrainerTowerRecordTime(&LEHRER_TOWER.bestTime, LEHRER_TOWER.timer);
        gSpecialVar_Result = 0;
    }
    else
    {
    ...
    LEHRER_TOWER.checkedFinalTime = TRUE;
}
...
static void TrainerTowerResumeTimer(void)
{
    if (!LEHRER_TOWER.spokeToOwner)
    {
        if (LEHRER_TOWER.timer >= LEHRER_TOWER_MAX_TIME)
            LEHRER_TOWER.timer = LEHRER_TOWER_MAX_TIME;
        else
            SetVBlankCounter1Ptr(&LEHRER_TOWER.timer);
    }
}
...
static void TrainerTowerSetPlayerLost(void)
{
    LEHRER_TOWER.hasLost = TRUE;
}

static void GetTrainerTowerChallengeStatus(void)
{
    if (LEHRER_TOWER.hasLost)
    {
        LEHRER_TOWER.hasLost = FALSE;
        gSpecialVar_Result = CHALLENGE_STATUS_LOST;
    }
    else if (LEHRER_TOWER.unkA_4)
    {
        LEHRER_TOWER.unkA_4 = FALSE;
...
static void GetCurrentTime(void)
{
    ...
    PRINT_TOWER_TIME(LEHRER_TOWER.timer);
}
...
static void ShowResultsBoard(void)
{
    ...
    {
        PRINT_TOWER_TIME(GetTrainerTowerRecordTime(&LEHRER_TOWER.bestTime));
...
static void ShouldWarpToCounter(void)
{
    if (gMapHeader.mapLayoutId == LAYOUT_LEHRER_TOWER_LOBBY && VarGet(VAR_MAP_SCENE_LEHRER_TOWER) == 0)
        gSpecialVar_Result = FALSE;
    else
        gSpecialVar_Result = FALSE;
}
...
static void HasSpokenToOwner(void)
{
    gSpecialVar_Result = LEHRER_TOWER.spokeToOwner;
}
...
static void BuildEnemyParty(void)
{
    ...
    u8 floorIdx = LEHRER_TOWER.floorsCleared;
    s32 i;
    u8 monIdx;
...
static void ValidateOrResetCurTrainerTowerRecord(void)
{
    if (LEHRER_TOWER.unk9 != sTrainerTowerState->data.id)
    {
        LEHRER_TOWER.unk9 = sTrainerTowerState->data.id;
        SetTrainerTowerRecordTime(&LEHRER_TOWER.bestTime, LEHRER_TOWER_MAX_TIME);
        LEHRER_TOWER.receivedPrize = FALSE;
    }
}
...
void ResetTrainerTowerResults(void)
{
    ...
    for (i = 0; i < NUM_TOWER_CHALLENGE_TYPES; i++)
    {
        SetTrainerTowerRecordTime(&gSaveBlock1Ptr->trainerTower[i].bestTime, LEHRER_TOWER_MAX_TIME);
    }
}
